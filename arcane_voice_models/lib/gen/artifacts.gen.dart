...
extension $RealtimeTextInputRequest on _g{
  _g get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[11]:_0.ea(text),}.$nn;}
  static _19 get from=>_19(fromMap);
  static _g fromMap(_5 r){_;_5 m=r.$nn;return _g(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[6],text: m.$c(_S[11])? _0.da(m[_S[11]], _7) as _7:throw __x(_S[12],_S[11]),);}
...
extension $RealtimeToolResultRequest on _i{
  _i get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[13]:_0.ea(requestId),_S[14]:_0.ea(outputJson),_S[15]:_0.ea(error),}.$nn;}
  static _1b get from=>_1b(fromMap);
  static _i fromMap(_5 r){_;_5 m=r.$nn;return _i(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[8],requestId: m.$c(_S[13])? _0.da(m[_S[13]], _7) as _7:throw __x(_S[16],_S[13]),outputJson: m.$c(_S[14])? _0.da(m[_S[14]], _7) as _7:throw __x(_S[16],_S[14]),error: m.$c(_S[15]) ?  _0.da(m[_S[15]], _7) as _7? : null,);}
...
extension $RealtimeConnectionReadyEvent on _j{
  _j get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[17]:providers.$m((e)=> _0.ea(e)).$l,_S[18]:_0.ea(defaultModel),_S[19]:_0.ea(defaultVoice),}.$nn;}
  static _1c get from=>_1c(fromMap);
  static _j fromMap(_5 r){_;_5 m=r.$nn;return _j(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[9],providers: m.$c(_S[17])? (m[_S[17]] as _14).$m((e)=> _0.da(e, _7) as _7).$l:throw __x(_S[20],_S[17]),defaultModel: m.$c(_S[18])? _0.da(m[_S[18]], _7) as _7:throw __x(_S[20],_S[18]),defaultVoice: m.$c(_S[19])? _0.da(m[_S[19]], _7) as _7:throw __x(_S[20],_S[19]),);}
...
extension $RealtimeToolCallEvent on _k{
  _k get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[13]:_0.ea(requestId),_S[21]:_0.ea(name),_S[22]:_0.ea(argumentsJson),}.$nn;}
  static _1d get from=>_1d(fromMap);
  static _k fromMap(_5 r){_;_5 m=r.$nn;return _k(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[10],requestId: m.$c(_S[13])? _0.da(m[_S[13]], _7) as _7:throw __x(_S[23],_S[13]),name: m.$c(_S[21])? _0.da(m[_S[21]], _7) as _7:throw __x(_S[23],_S[21]),argumentsJson: m.$c(_S[22])? _0.da(m[_S[22]], _7) as _7:throw __x(_S[23],_S[22]),);}
...
extension $RealtimeSessionStartedEvent on _l{
  _l get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[1]:_0.ea(provider),_S[2]:_0.ea(model),_S[3]:_0.ea(voice),_S[6]:_0.ea(inputSampleRate),_S[7]:_0.ea(outputSampleRate),}.$nn;}
  static _1e get from=>_1e(fromMap);
  static _l fromMap(_5 r){_;_5 m=r.$nn;return _l(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[11],provider: m.$c(_S[1])? _0.da(m[_S[1]], _7) as _7:throw __x(_S[24],_S[1]),model: m.$c(_S[2])? _0.da(m[_S[2]], _7) as _7:throw __x(_S[24],_S[2]),voice: m.$c(_S[3])? _0.da(m[_S[3]], _7) as _7:throw __x(_S[24],_S[3]),inputSampleRate: m.$c(_S[6])? _0.da(m[_S[6]], _9) as _9:throw __x(_S[24],_S[6]),outputSampleRate: m.$c(_S[7])? _0.da(m[_S[7]], _9) as _9:throw __x(_S[24],_S[7]),);}
...
extension $RealtimeSessionStateEvent on _m{
  _m get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[25]:_0.ea(state),_S[1]:_0.ea(provider),}.$nn;}
  static _1f get from=>_1f(fromMap);
  static _m fromMap(_5 r){_;_5 m=r.$nn;return _m(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[12],state: m.$c(_S[25])? _0.da(m[_S[25]], _7) as _7:throw __x(_S[26],_S[25]),provider: m.$c(_S[1]) ?  _0.da(m[_S[1]], _7) as _7? : null,);}
...
extension $RealtimeErrorEvent on _p{
  _p get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[27]:_0.ea(message),_S[28]:_0.ea(code),}.$nn;}
  static _1i get from=>_1i(fromMap);
  static _p fromMap(_5 r){_;_5 m=r.$nn;return _p(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[15],message: m.$c(_S[27])? _0.da(m[_S[27]], _7) as _7:throw __x(_S[29],_S[27]),code: m.$c(_S[28]) ?  _0.da(m[_S[28]], _7) as _7? : null,);}
...
extension $RealtimeTranscriptUserDeltaEvent on _s{
  ...
  static _s fromMap(_5 r){_;_5 m=r.$nn;return _s(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[18],text: m.$c(_S[11])? _0.da(m[_S[11]], _7) as _7:throw __x(_S[30],_S[11]),);}
...
extension $RealtimeTranscriptUserFinalEvent on _t{
  ...
  static _t fromMap(_5 r){_;_5 m=r.$nn;return _t(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[19],text: m.$c(_S[11])? _0.da(m[_S[11]], _7) as _7:throw __x(_S[31],_S[11]),);}
...
extension $RealtimeTranscriptAssistantDeltaEvent on _u{
  ...
  static _u fromMap(_5 r){_;_5 m=r.$nn;return _u(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[20],text: m.$c(_S[11])? _0.da(m[_S[11]], _7) as _7:throw __x(_S[32],_S[11]),);}
...
extension $RealtimeTranscriptAssistantFinalEvent on _v{
  ...
  static _v fromMap(_5 r){_;_5 m=r.$nn;return _v(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[21],text: m.$c(_S[11])? _0.da(m[_S[11]], _7) as _7:throw __x(_S[33],_S[11]),);}
...
extension $RealtimeAssistantOutputCompletedEvent on _x{
  _x get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[34]:_0.ea(reason),}.$nn;}
  static _1q get from=>_1q(fromMap);
  static _x fromMap(_5 r){_;_5 m=r.$nn;return _x(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[23],reason: m.$c(_S[34]) ?  _0.da(m[_S[34]], _7) as _7 : _V[24],);}
...
extension $RealtimeToolStartedEvent on _y{
  _y get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[35]:_0.ea(callId),_S[21]:_0.ea(name),_S[36]:_0.ea(executionTarget),}.$nn;}
  static _1r get from=>_1r(fromMap);
  static _y fromMap(_5 r){_;_5 m=r.$nn;return _y(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[25],callId: m.$c(_S[35])? _0.da(m[_S[35]], _7) as _7:throw __x(_S[37],_S[35]),name: m.$c(_S[21])? _0.da(m[_S[21]], _7) as _7:throw __x(_S[37],_S[21]),executionTarget: m.$c(_S[36])? _0.da(m[_S[36]], _7) as _7:throw __x(_S[37],_S[36]),);}
...
extension $RealtimeToolCompletedEvent on _z{
  _z get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[35]:_0.ea(callId),_S[21]:_0.ea(name),_S[36]:_0.ea(executionTarget),_S[38]:_0.ea(success),_S[15]:_0.ea(error),}.$nn;}
  static _1s get from=>_1s(fromMap);
  static _z fromMap(_5 r){_;_5 m=r.$nn;return _z(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[26],callId: m.$c(_S[35])? _0.da(m[_S[35]], _7) as _7:throw __x(_S[39],_S[35]),name: m.$c(_S[21])? _0.da(m[_S[21]], _7) as _7:throw __x(_S[39],_S[21]),executionTarget: m.$c(_S[36])? _0.da(m[_S[36]], _7) as _7:throw __x(_S[39],_S[36]),success: m.$c(_S[38]) ?  _0.da(m[_S[38]], _15) as _15 : _V[27],error: m.$c(_S[15]) ?  _0.da(m[_S[15]], _7) as _7? : null,);}
...
extension $RealtimeProviderDefinition on _10{
  _10 get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{'id':_0.ea(id),_S[40]:_0.ea(label),_S[18]:_0.ea(defaultModel),_S[19]:_0.ea(defaultVoice),_S[41]:voices.$m((e)=> _0.ea(e)).$l,}.$nn;}
  static _1t get from=>_1t(fromMap);
  static _10 fromMap(_5 r){_;_5 m=r.$nn;return _10(id: m.$c('id')? _0.da(m['id'], _7) as _7:throw __x(_S[42],'id'),label: m.$c(_S[40])? _0.da(m[_S[40]], _7) as _7:throw __x(_S[42],_S[40]),defaultModel: m.$c(_S[18])? _0.da(m[_S[18]], _7) as _7:throw __x(_S[42],_S[18]),defaultVoice: m.$c(_S[19])? _0.da(m[_S[19]], _7) as _7:throw __x(_S[42],_S[19]),voices: m.$c(_S[41])? (m[_S[41]] as _14).$m((e)=> _0.da(e, _7) as _7).$l:throw __x(_S[42],_S[41]),);}
...
extension $RealtimeToolDefinition on _11{
  _11 get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[21]:_0.ea(name),_S[43]:_0.ea(description),_S[44]:_0.ea(parametersJson),}.$nn;}
  static _1u get from=>_1u(fromMap);
  static _11 fromMap(_5 r){_;_5 m=r.$nn;return _11(name: m.$c(_S[21])? _0.da(m[_S[21]], _7) as _7:throw __x(_S[45],_S[21]),description: m.$c(_S[43])? _0.da(m[_S[43]], _7) as _7:throw __x(_S[45],_S[43]),parametersJson: m.$c(_S[44])? _0.da(m[_S[44]], _7) as _7:throw __x(_S[45],_S[44]),);}
...
extension $RealtimeTurnDetectionConfig on _12{
  _12 get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[46]:_0.ea(speechThresholdRms),_S[47]:_0.ea(speechStartMs),_S[48]:_0.ea(speechEndSilenceMs),_S[49]:_0.ea(preSpeechMs),_S[50]:_0.ea(bargeInEnabled),}.$nn;}
  static _1v get from=>_1v(fromMap);
  static _12 fromMap(_5 r){_;_5 m=r.$nn;return _12(speechThresholdRms: m.$c(_S[46]) ?  _0.da(m[_S[46]], _9) as _9 : 100,speechStartMs: m.$c(_S[47]) ?  _0.da(m[_S[47]], _9) as _9 : 200,speechEndSilenceMs: m.$c(_S[48]) ?  _0.da(m[_S[48]], _9) as _9 : 900,preSpeechMs: m.$c(_S[49]) ?  _0.da(m[_S[49]], _9) as _9 : 300,bargeInEnabled: m.$c(_S[50]) ?  _0.da(m[_S[50]], _15) as _15 : _V[27],);}
