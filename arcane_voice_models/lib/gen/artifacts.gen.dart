...
extension $RealtimeSessionStopRequest on _e{
  ...
  _e copyWith({_7? type,_15 resetType=_F,})=>_e(type: resetType?_V[3]:(type??_H.type),);
...
extension $RealtimeSessionInterruptRequest on _f{
  ...
  _f copyWith({_7? type,_15 resetType=_F,})=>_f(type: resetType?_V[4]:(type??_H.type),);
...
extension $RealtimeTextInputRequest on _g{
  ...
  _g copyWith({_7? type,_15 resetType=_F,_7? text,})=>_g(type: resetType?_V[5]:(type??_H.type),text: text??_H.text,);
...
extension $RealtimePingRequest on _h{
  ...
  _h copyWith({_7? type,_15 resetType=_F,})=>_h(type: resetType?_V[6]:(type??_H.type),);
...
extension $RealtimeToolResultRequest on _i{
  ...
  _i copyWith({_7? type,_15 resetType=_F,_7? requestId,_7? outputJson,_7? error,_15 deleteError=_F,})=>_i(type: resetType?_V[7]:(type??_H.type),requestId: requestId??_H.requestId,outputJson: outputJson??_H.outputJson,error: deleteError?null:(error??_H.error),);
...
extension $RealtimeConnectionReadyEvent on _j{
  ...
  static _j fromMap(_5 r){_;_5 m=r.$nn;return _j(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[8],providers: m.$c(_S[16])? (m[_S[16]] as _14).$m((e)=> _0.da(e, _7) as _7).$l:throw __x(_S[19],_S[16]),defaultModel: m.$c(_S[17])? _0.da(m[_S[17]], _7) as _7:throw __x(_S[19],_S[17]),defaultVoice: m.$c(_S[18])? _0.da(m[_S[18]], _7) as _7:throw __x(_S[19],_S[18]),);}
...
extension $RealtimeToolCallEvent on _k{
  ...
  _k copyWith({_7? type,_15 resetType=_F,_7? requestId,_7? name,_7? argumentsJson,})=>_k(type: resetType?_V[9]:(type??_H.type),requestId: requestId??_H.requestId,name: name??_H.name,argumentsJson: argumentsJson??_H.argumentsJson,);
...
extension $RealtimeSessionStartedEvent on _l{
  ...
  _l copyWith({_7? type,_15 resetType=_F,_7? provider,_7? model,_7? voice,_9? inputSampleRate,_9? deltaInputSampleRate,_9? outputSampleRate,_9? deltaOutputSampleRate,})=>_l(type: resetType?_V[10]:(type??_H.type),provider: provider??_H.provider,model: model??_H.model,voice: voice??_H.voice,inputSampleRate: deltaInputSampleRate!=null?(inputSampleRate??_H.inputSampleRate)+deltaInputSampleRate:inputSampleRate??_H.inputSampleRate,outputSampleRate: deltaOutputSampleRate!=null?(outputSampleRate??_H.outputSampleRate)+deltaOutputSampleRate:outputSampleRate??_H.outputSampleRate,);
...
extension $RealtimeSessionStateEvent on _m{
  ...
  _m copyWith({_7? type,_15 resetType=_F,_7? state,_7? provider,_15 deleteProvider=_F,})=>_m(type: resetType?_V[11]:(type??_H.type),state: state??_H.state,provider: deleteProvider?null:(provider??_H.provider),);
...
extension $RealtimeSessionStoppedEvent on _n{
  ...
  _n copyWith({_7? type,_15 resetType=_F,})=>_n(type: resetType?_V[12]:(type??_H.type),);
...
extension $RealtimePongEvent on _o{
  ...
  _o copyWith({_7? type,_15 resetType=_F,})=>_o(type: resetType?_V[13]:(type??_H.type),);
...
extension $RealtimeErrorEvent on _p{
  ...
  _p copyWith({_7? type,_15 resetType=_F,_7? message,_7? code,_15 deleteCode=_F,})=>_p(type: resetType?_V[14]:(type??_H.type),message: message??_H.message,code: deleteCode?null:(code??_H.code),);
...
extension $RealtimeInputSpeechStartedEvent on _q{
  ...
  _q copyWith({_7? type,_15 resetType=_F,})=>_q(type: resetType?_V[15]:(type??_H.type),);
...
extension $RealtimeInputSpeechStoppedEvent on _r{
  ...
  _r copyWith({_7? type,_15 resetType=_F,})=>_r(type: resetType?_V[16]:(type??_H.type),);
...
extension $RealtimeTranscriptUserDeltaEvent on _s{
  ...
  _s copyWith({_7? type,_15 resetType=_F,_7? text,})=>_s(type: resetType?_V[17]:(type??_H.type),text: text??_H.text,);
...
extension $RealtimeTranscriptUserFinalEvent on _t{
  ...
  _t copyWith({_7? type,_15 resetType=_F,_7? text,})=>_t(type: resetType?_V[18]:(type??_H.type),text: text??_H.text,);
...
extension $RealtimeTranscriptAssistantDeltaEvent on _u{
  ...
  _u copyWith({_7? type,_15 resetType=_F,_7? text,})=>_u(type: resetType?_V[19]:(type??_H.type),text: text??_H.text,);
...
extension $RealtimeTranscriptAssistantFinalEvent on _v{
  ...
  _v copyWith({_7? type,_15 resetType=_F,_7? text,})=>_v(type: resetType?_V[20]:(type??_H.type),text: text??_H.text,);
...
extension $RealtimeTranscriptAssistantDiscardEvent on _w{
  ...
  _w copyWith({_7? type,_15 resetType=_F,})=>_w(type: resetType?_V[21]:(type??_H.type),);
  static _w get newInstance=>_w();
}
extension $RealtimeAssistantOutputCompletedEvent on _x{
  _x get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[33]:_0.ea(reason),}.$nn;}
  static _1q get from=>_1q(fromMap);
  static _x fromMap(_5 r){_;_5 m=r.$nn;return _x(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[22],reason: m.$c(_S[33]) ?  _0.da(m[_S[33]], _7) as _7 : _V[23],);}
  _x copyWith({_7? type,_15 resetType=_F,_7? reason,_15 resetReason=_F,})=>_x(type: resetType?_V[22]:(type??_H.type),reason: resetReason?_V[23]:(reason??_H.reason),);
  static _x get newInstance=>_x();
}
extension $RealtimeToolStartedEvent on _y{
  _y get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[34]:_0.ea(callId),_S[20]:_0.ea(name),_S[35]:_0.ea(executionTarget),}.$nn;}
  static _1r get from=>_1r(fromMap);
  static _y fromMap(_5 r){_;_5 m=r.$nn;return _y(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[24],callId: m.$c(_S[34])? _0.da(m[_S[34]], _7) as _7:throw __x(_S[36],_S[34]),name: m.$c(_S[20])? _0.da(m[_S[20]], _7) as _7:throw __x(_S[36],_S[20]),executionTarget: m.$c(_S[35])? _0.da(m[_S[35]], _7) as _7:throw __x(_S[36],_S[35]),);}
  _y copyWith({_7? type,_15 resetType=_F,_7? callId,_7? name,_7? executionTarget,})=>_y(type: resetType?_V[24]:(type??_H.type),callId: callId??_H.callId,name: name??_H.name,executionTarget: executionTarget??_H.executionTarget,);
  static _y get newInstance=>_y(callId: '',name: '',executionTarget: '',);
}
extension $RealtimeToolCompletedEvent on _z{
  _z get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[0]:_0.ea(type),_S[34]:_0.ea(callId),_S[20]:_0.ea(name),_S[35]:_0.ea(executionTarget),_S[37]:_0.ea(success),_S[14]:_0.ea(error),}.$nn;}
  static _1s get from=>_1s(fromMap);
  static _z fromMap(_5 r){_;_5 m=r.$nn;return _z(type: m.$c(_S[0]) ?  _0.da(m[_S[0]], _7) as _7 : _V[25],callId: m.$c(_S[34])? _0.da(m[_S[34]], _7) as _7:throw __x(_S[38],_S[34]),name: m.$c(_S[20])? _0.da(m[_S[20]], _7) as _7:throw __x(_S[38],_S[20]),executionTarget: m.$c(_S[35])? _0.da(m[_S[35]], _7) as _7:throw __x(_S[38],_S[35]),success: m.$c(_S[37]) ?  _0.da(m[_S[37]], _15) as _15 : _V[26],error: m.$c(_S[14]) ?  _0.da(m[_S[14]], _7) as _7? : null,);}
  _z copyWith({_7? type,_15 resetType=_F,_7? callId,_7? name,_7? executionTarget,_15? success,_15 resetSuccess=_F,_7? error,_15 deleteError=_F,})=>_z(type: resetType?_V[25]:(type??_H.type),callId: callId??_H.callId,name: name??_H.name,executionTarget: executionTarget??_H.executionTarget,success: resetSuccess?_V[26]:(success??_H.success),error: deleteError?null:(error??_H.error),);
  static _z get newInstance=>_z(callId: '',name: '',executionTarget: '',);
}
extension $RealtimeProviderDefinition on _10{
  _10 get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{'id':_0.ea(id),_S[39]:_0.ea(label),_S[17]:_0.ea(defaultModel),_S[18]:_0.ea(defaultVoice),_S[40]:voices.$m((e)=> _0.ea(e)).$l,}.$nn;}
  static _1t get from=>_1t(fromMap);
  static _10 fromMap(_5 r){_;_5 m=r.$nn;return _10(id: m.$c('id')? _0.da(m['id'], _7) as _7:throw __x(_S[41],'id'),label: m.$c(_S[39])? _0.da(m[_S[39]], _7) as _7:throw __x(_S[41],_S[39]),defaultModel: m.$c(_S[17])? _0.da(m[_S[17]], _7) as _7:throw __x(_S[41],_S[17]),defaultVoice: m.$c(_S[18])? _0.da(m[_S[18]], _7) as _7:throw __x(_S[41],_S[18]),voices: m.$c(_S[40])? (m[_S[40]] as _14).$m((e)=> _0.da(e, _7) as _7).$l:throw __x(_S[41],_S[40]),);}
...
extension $RealtimeToolDefinition on _11{
  _11 get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[20]:_0.ea(name),_S[42]:_0.ea(description),_S[43]:_0.ea(parametersJson),}.$nn;}
  static _1u get from=>_1u(fromMap);
  static _11 fromMap(_5 r){_;_5 m=r.$nn;return _11(name: m.$c(_S[20])? _0.da(m[_S[20]], _7) as _7:throw __x(_S[44],_S[20]),description: m.$c(_S[42])? _0.da(m[_S[42]], _7) as _7:throw __x(_S[44],_S[42]),parametersJson: m.$c(_S[43])? _0.da(m[_S[43]], _7) as _7:throw __x(_S[44],_S[43]),);}
